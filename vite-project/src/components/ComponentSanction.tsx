    ...
    return (
        <div className={`${onShow === true ? 'card-displayer' : 'card-hidden'}`}>
            ...
            <div className='para-box-card'>
                ...
                <div className='div-card-item'>
                    <p className='p-card-second'>{findCardSanction.ask || "Question indisponible"}</p>
                </div>
                ...
                <div className='div-card-item'>
                    ...
                    {response === true ? (
                        <p className='p-card-third'>{findCardSanction.answer || "Réponse indisponible"}</p>
                    ) : (
